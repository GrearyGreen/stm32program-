...
//	GPIO_PinRemapConfig(GPIO_Remap_TIM4, ENABLE); //Timer4重映射  TIM4_CH2->PD13    
...
{  
	...
	GPIO_PinRemapConfig(GPIO_PartialRemap2_TIM2, ENABLE);  //Timer4重映射  TIM4_CH2->PD13    
