...
void LCD_Fast_DrawBigPoint(u16 x,u16 y,u16 color)
{
	LCD_Fast_DrawPoint(x-2,y+1,color);
	LCD_Fast_DrawPoint(x-2,y-1,color);
	LCD_Fast_DrawPoint(x-2,y,color);
	LCD_Fast_DrawPoint(x-2,y-2,color);
	LCD_Fast_DrawPoint(x-2,y+2,color);
	...
	LCD_Fast_DrawPoint(x-1,y-2,color);
	LCD_Fast_DrawPoint(x-1,y+2,color);
	LCD_Fast_DrawPoint(x-1,y+1,color);
	LCD_Fast_DrawPoint(x-1,y-1,color);
	LCD_Fast_DrawPoint(x-1,y,color);
	
	LCD_Fast_DrawPoint(x,y-2,color);
	LCD_Fast_DrawPoint(x,y+2,color);
